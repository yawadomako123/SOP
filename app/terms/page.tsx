export default function TermsPage() {
  return (
    <main className="container flex flex-col gap-4 self-center p-4 text-sm md:p-6">
      ...
      <p>
        This website is operated by Nienalabs Starter Kit. Throughout the site,
        the terms “we”, “us” and “our” refer to Nienalabs Starter Kit. Nienalabs
        Starter Kit offers this website, including all information, tools and
      ...
      <p>
        In no case shall Nienalabs Starter Kit, our directors, officers,
      ...
      <p>
        You agree to indemnify, defend and hold harmless Nienalabs Starter Kit and
      ...
      <p>
        ...
        laws of Ghana under the 1992 constitution.
      </p>
